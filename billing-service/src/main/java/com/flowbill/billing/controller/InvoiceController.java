...
public class InvoiceController {
    ...
    public Invoice generateInvoice(@RequestHeader(TenantConstants.TENANT_ID_HEADER) String tenantId) {
        // Call Time Service (passing the Tenant ID header for routing)
        // In real app, use FeignRequestInterceptor. Here manually adding header logic
        // to RestTemplate is needed
        // For simplicity of this scaffolding, we assume direct URL call without complex
        // header prop in this block
